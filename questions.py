...
palabras = random.sample(categorias[categoria],len(categorias[categoria])) #devuelve los elementos seleccionados al azar en una nueva lista sin repetrirlos

print("¡Bienvenido al Ahorcado!")
print()

for word in palabras:  #para jugar varias rondas
    guessed = []
    attempts = 6
    score = 0 #el puntaje se reinicia en cada ronda
